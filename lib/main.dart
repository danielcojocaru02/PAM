...
class _LoanCalculatorScreenState extends State<LoanCalculatorScreen> {
  ...
  void _calculatePayment() {
    ...
    final double interestRate = (double.tryParse(_interestController.text) ?? 0) / 100;
    ...
    if (principal > 0 && interestRate > 0 && months > 0) {
      ...
      final double monthlyPayment = principal * monthlyRate * math.pow(1 + monthlyRate, months) / denominator;
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(8), // Set border radius to zero for no rounded corners
                  ),
                ),
                child: const Text(
                  'Calculate',
